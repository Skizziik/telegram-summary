...
public class MistralClient {
    ...
    public String summarize(String posts) throws IOException {
        ...
        String prompt = """
                ...
                Объединяй повторяющиеся и похожие новости в один пункт — одна и та же новость (даже разными словами или из разных каналов) должна встречаться в сводке только один раз.
